...
const FAQS = [
  {
    q: "Сколько стоит один ящик пива?",
    a: "Ящик пива из 12 бутылок — 1 200 ₽. Ящик пива из 24 бутылок (МАЙХАЙЛА / Maihaila) — 2 400 ₽.",
  },
  {
    q: "Какая минимальная партия для заказа?",
    a: "Минимальная партия для самовывоза — 1 ящик. Минимальная партия для доставки по городу и пригороду — 2 ящика.",
  },
  {
    q: "По каким городам осуществляется доставка?",
    a: "Доставка осуществляется по городу и пригороду Владивостока, Артёма и Уссурийска.",
  },
  {
    q: "Какие сроки доставки?",
    a: "Доставка по г. Владивостоку и его пригороду — в течение суток. Доставка в г. Артём, г. Уссурийск и их пригороды — в течение 48 часов.",
  },
  {
    q: "Где находится склад для самовывоза?",
    a: "Склад расположен по адресу: г. Владивосток, ул. Адм. Макарова, 41.",
  },
  {
    q: "Как сделать заказ?",
    a: "Для заказа и уточнения любых вопросов свяжитесь с нами по телефону: +7-908-442-32-17, или напишите на почту: vielvl.dd@gmail.com.",
  },
];
